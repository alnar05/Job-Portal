...
class DashboardControllerTest {
    ...
    void adminDashboard_shouldRenderView_whenAdmin() throws Exception {
        ...
        given(jobService.getAllJobs()).willReturn(List.of(new JobResponseDto()));
        given(applicationService.getAllApplications()).willReturn(List.of());
        given(userService.getUsersByRole(Role.EMPLOYER, PageRequest.of(0, 5))).willReturn(new PageImpl<>(List.of(employerUser)));
        given(userService.getUsersByRole(Role.CANDIDATE, PageRequest.of(0, 5))).willReturn(new PageImpl<>(List.of(candidateUser)));
